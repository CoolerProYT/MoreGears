...
public class MGArrowEntity extends PersistentProjectileEntity {
    ...
    public MGArrowEntity(EntityType<MGArrowEntity> entityType, LivingEntity owner, World level, ItemStack pickupItemStack, @Nullable ItemStack firedFromWeapon, double baseDamage) {
