...
public class MGArrowItem extends ArrowItem {
    ...
    public boolean isInfinite(ItemStack ammo, ItemStack bow, LivingEntity livingEntity) {
        return bow.getEnchantmentLevel(livingEntity.level().registryAccess().get(Enchantments.INFINITY).orElseThrow()) > 0;
    }
    ...
    public enum MGArrowType implements StringRepresentable {
        ...
        public static final Codec<MGArrowType> CODEC = StringRepresentable.fromEnum(MGArrowItem.MGArrowType::values);
