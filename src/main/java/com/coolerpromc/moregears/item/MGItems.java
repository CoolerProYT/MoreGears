...
public class MGItems {
    ...
    public static final BowItem ENDERITE_BOW = registerItem("enderite_bow", new BowItem(new Item.Settings().fireproof().maxDamage(Integer.MAX_VALUE).component(DataComponentTypes.UNBREAKABLE, new UnbreakableComponent(true))));
