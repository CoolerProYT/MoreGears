...
public class MGItems {
    ...
    public static final SwordItem COPPER_SWORD = registerItem("copper_sword",  new SwordItem(MGToolMaterials.COPPER_TIER, 3, -2.4F, new Item.Settings()));
    public static final PickaxeItem COPPER_PICKAXE = registerItem("copper_pickaxe",  new PickaxeItem(MGToolMaterials.COPPER_TIER, 1, -2.8f, new Item.Settings()));
    public static final ShovelItem COPPER_SHOVEL = registerItem("copper_shovel",  new ShovelItem(MGToolMaterials.COPPER_TIER, 1.5f, -3f, new Item.Settings()));
    public static final AxeItem COPPER_AXE = registerItem("copper_axe",  new AxeItem(MGToolMaterials.COPPER_TIER, 7, -3.2f, new Item.Settings()));
    public static final HoeItem COPPER_HOE = registerItem("copper_hoe",  new HoeItem(MGToolMaterials.COPPER_TIER, -1, -1.5f, new Item.Settings()));
    ...
    public static final SwordItem BRONZE_SWORD = registerItem("bronze_sword",  new SwordItem(MGToolMaterials.BRONZE_TIER, 3, -2.4F, new Item.Settings()));
    public static final PickaxeItem BRONZE_PICKAXE = registerItem("bronze_pickaxe",  new BronzePickaxe(MGToolMaterials.BRONZE_TIER, 1, -2.8f, new Item.Settings()));
    public static final ShovelItem BRONZE_SHOVEL = registerItem("bronze_shovel",  new BronzeShovel(MGToolMaterials.BRONZE_TIER, 1.5f, -3f, new Item.Settings()));
    public static final AxeItem BRONZE_AXE = registerItem("bronze_axe",  new BronzeAxe(MGToolMaterials.BRONZE_TIER, 5.5f, -3.0f, new Item.Settings()));
    public static final HoeItem BRONZE_HOE = registerItem("bronze_hoe",  new BronzeHoe(MGToolMaterials.BRONZE_TIER, -2, -0.5f, new Item.Settings()));
    ...
    public static final SwordItem STEEL_SWORD = registerItem("steel_sword",  new SteelSword(MGToolMaterials.STEEL_TIER, 3, -1.4F, new Item.Settings()));
    public static final PickaxeItem STEEL_PICKAXE = registerItem("steel_pickaxe",  new SteelPickaxe(MGToolMaterials.STEEL_TIER, 1, -1.8f, new Item.Settings()));
    public static final ShovelItem STEEL_SHOVEL = registerItem("steel_shovel",  new SteelShovel(MGToolMaterials.STEEL_TIER, 1.5f, -2f, new Item.Settings()));
    public static final AxeItem STEEL_AXE = registerItem("steel_axe",  new SteelAxe(MGToolMaterials.STEEL_TIER, 6, -2f, new Item.Settings()));
    public static final HoeItem STEEL_HOE = registerItem("steel_hoe",  new SteelHoe(MGToolMaterials.STEEL_TIER, -2, 0.0f, new Item.Settings()));
    ...
    public static final SwordItem RUBY_SWORD = registerItem("ruby_sword",  new SwordItem(MGToolMaterials.RUBY_TIER, 3, -2.4F, new Item.Settings()));
    public static final PickaxeItem RUBY_PICKAXE = registerItem("ruby_pickaxe",  new PickaxeItem(MGToolMaterials.RUBY_TIER, 1, -2.8f, new Item.Settings()));
    public static final ShovelItem RUBY_SHOVEL = registerItem("ruby_shovel",  new ShovelItem(MGToolMaterials.RUBY_TIER, 1.5f, -3f, new Item.Settings()));
    public static final AxeItem RUBY_AXE = registerItem("ruby_axe",  new AxeItem(MGToolMaterials.RUBY_TIER, 4, -3.2f, new Item.Settings()));
    public static final HoeItem RUBY_HOE = registerItem("ruby_hoe",  new HoeItem(MGToolMaterials.RUBY_TIER, -3, 0f, new Item.Settings()));
    ...
    public static final SwordItem TITANIUM_SWORD = registerItem("titanium_sword",  new SwordItem(MGToolMaterials.TITANIUM_TIER, 5, -1.5F, new Item.Settings()));
    public static final PickaxeItem TITANIUM_PICKAXE = registerItem("titanium_pickaxe",  new PickaxeItem(MGToolMaterials.TITANIUM_TIER, 2, -2f, new Item.Settings()));
    public static final ShovelItem TITANIUM_SHOVEL = registerItem("titanium_shovel",  new ShovelItem(MGToolMaterials.TITANIUM_TIER, 2f, -2f, new Item.Settings()));
    public static final AxeItem TITANIUM_AXE = registerItem("titanium_axe",  new AxeItem(MGToolMaterials.TITANIUM_TIER, 6, -2.2f, new Item.Settings()));
    public static final HoeItem TITANIUM_HOE = registerItem("titanium_hoe",  new HoeItem(MGToolMaterials.TITANIUM_TIER, -2, 0.0f, new Item.Settings()));
    ...
    public static final SwordItem ENDERITE_SWORD = registerItem("enderite_sword",
             new SwordItem(MGToolMaterials.ENDERITE_TIER, 8, -1F, new Item.Settings().fireproof()){
                 @Override
    ...
    public static final PickaxeItem ENDERITE_PICKAXE = registerItem("enderite_pickaxe",
             new PickaxeItem(MGToolMaterials.ENDERITE_TIER, 4, -1.3f, new Item.Settings().fireproof()){
                 @Override
                 public boolean isDamageable() {
                     return false;
                 }
    ...
    public static final ShovelItem ENDERITE_SHOVEL = registerItem("enderite_shovel",
             new ShovelItem(MGToolMaterials.ENDERITE_TIER, 3.5f, -1.8f, new Item.Settings().fireproof()){
                 @Override
                 public boolean isDamageable() {
                     return false;
                 }
    ...
    public static final AxeItem ENDERITE_AXE = registerItem("enderite_axe",
             new AxeItem(MGToolMaterials.ENDERITE_TIER, 9, -1.5f, new Item.Settings().fireproof()){
                 @Override
                 public boolean isDamageable() {
                     return false;
                 }
    ...
    public static final HoeItem ENDERITE_HOE = registerItem("enderite_hoe",
             new HoeItem(MGToolMaterials.ENDERITE_TIER, -1, 0.0f, new Item.Settings().fireproof()){
                 @Override
                 public boolean isDamageable() {
                     return false;
                 }
    ...
    public static final MGArrowItem COPPER_ARROW = registerItem("copper_arrow", new MGArrowItem(new Item.Settings(), 1.75D, MGEntities.COPPER_ARROW));
    public static final MGArrowItem BRONZE_ARROW = registerItem("bronze_arrow", new MGArrowItem(new Item.Settings(), 2.5D, MGEntities.BRONZE_ARROW));
    public static final MGArrowItem STEEL_ARROW = registerItem("steel_arrow", new MGArrowItem(new Item.Settings(), 3.0D, MGEntities.STEEL_ARROW));
    public static final MGArrowItem RUBY_ARROW = registerItem("ruby_arrow", new MGArrowItem(new Item.Settings(), 3.5D, MGEntities.RUBY_ARROW));
    public static final MGArrowItem TITANIUM_ARROW = registerItem("titanium_arrow", new MGArrowItem(new Item.Settings(), 4.5D, MGEntities.TITANIUM_ARROW));
    public static final MGArrowItem ENDERITE_ARROW = registerItem("enderite_arrow", new MGArrowItem(new Item.Settings(), 5.0D, MGEntities.ENDERITE_ARROW));

    public static final BowItem COPPER_BOW = registerItem("copper_bow", new BowItem(new Item.Settings().maxDamage(520)));
    public static final BowItem BRONZE_BOW = registerItem("bronze_bow", new BowItem(new Item.Settings().maxDamage(789)));
    public static final BowItem STEEL_BOW = registerItem("steel_bow", new BowItem(new Item.Settings().maxDamage(1115)));
    public static final BowItem RUBY_BOW = registerItem("ruby_bow", new BowItem(new Item.Settings().maxDamage(1442)));
    public static final BowItem TITANIUM_BOW = registerItem("titanium_bow", new BowItem(new Item.Settings().maxDamage(1763)));
    public static final BowItem ENDERITE_BOW = registerItem("enderite_bow", new BowItem(new Item.Settings().fireproof().maxDamage(Integer.MAX_VALUE)){
        @Override
        public boolean isDamageable() {
            return false;
        }
