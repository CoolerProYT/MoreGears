...
public class MGItems {
    ...
    public static final DeferredItem<MGNugget> TITANIUM_NUGGET = registerItem("titanium_nugget", properties -> new MGNugget(properties, MGColors.TITANIUM_COLOR));
    ...
    public static final DeferredItem<BowItem> ENDERITE_BOW = registerItem("enderite_bow", properties -> new BowItem(properties.fireResistant().durability(Integer.MAX_VALUE).enchantable(1).component(DataComponents.UNBREAKABLE, new Unbreakable(true))));
