...
public class MGBlockEntities {
    public static final BlockEntityType<AlloySmelterBlockEntity> ALLOY_SMELTER_BE = register("alloy_smelter_be", FabricBlockEntityTypeBuilder.create(AlloySmelterBlockEntity::new, MGBlocks.ALLOY_SMELTER).build());
