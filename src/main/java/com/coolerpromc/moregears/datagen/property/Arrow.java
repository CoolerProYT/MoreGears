...
public record Arrow() implements SelectProperty<MGArrowItem.MGArrowType> {
    ...
    @Override
    public @Nullable MGArrowItem.MGArrowType getValue(ItemStack itemStack, @Nullable ClientWorld clientLevel, @Nullable LivingEntity livingEntity, int i, ItemDisplayContext itemDisplayContext) {
