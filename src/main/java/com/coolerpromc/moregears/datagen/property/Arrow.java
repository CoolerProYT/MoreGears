...
public class Arrow {
    ...
    public static void addBowItemProperties(){
        ItemProperties.register(Items.BOW, new ResourceLocation(MoreGears.MODID, "select_arrow"), (itemStack, clientLevel, livingEntity, i) -> getValue(itemStack, livingEntity));
        ItemProperties.register(MGItems.COPPER_BOW.get(), new ResourceLocation(MoreGears.MODID, "select_arrow"), (itemStack, clientLevel, livingEntity, i) -> getValue(itemStack, livingEntity));
        ItemProperties.register(MGItems.BRONZE_BOW.get(), new ResourceLocation(MoreGears.MODID, "select_arrow"), (itemStack, clientLevel, livingEntity, i) -> getValue(itemStack, livingEntity));
        ItemProperties.register(MGItems.STEEL_BOW.get(), new ResourceLocation(MoreGears.MODID, "select_arrow"), (itemStack, clientLevel, livingEntity, i) -> getValue(itemStack, livingEntity));
        ItemProperties.register(MGItems.RUBY_BOW.get(), new ResourceLocation(MoreGears.MODID, "select_arrow"), (itemStack, clientLevel, livingEntity, i) -> getValue(itemStack, livingEntity));
        ItemProperties.register(MGItems.TITANIUM_BOW.get(), new ResourceLocation(MoreGears.MODID, "select_arrow"), (itemStack, clientLevel, livingEntity, i) -> getValue(itemStack, livingEntity));
        ItemProperties.register(MGItems.ENDERITE_BOW.get(), new ResourceLocation(MoreGears.MODID, "select_arrow"), (itemStack, clientLevel, livingEntity, i) -> getValue(itemStack, livingEntity));
