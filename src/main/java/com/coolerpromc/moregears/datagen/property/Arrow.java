...
public class Arrow {
    ...
    private static void makeCustomBow(Item item) {
        ModelPredicateProviderRegistry.register(item, new Identifier("pull"), (p_344163_, p_344164_, p_344165_, p_344166_) -> {
            if (p_344165_ == null) {
                return 0.0F;
            } else {
                return p_344165_.getActiveItem() != p_344163_ ? 0.0F : (float)(p_344163_.getMaxUseTime() - p_344165_.getItemUseTimeLeft()) / 20.0F;
            }
        });
