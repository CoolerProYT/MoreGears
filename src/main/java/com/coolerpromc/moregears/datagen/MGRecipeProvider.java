...
public class MGRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(RecipeExporter recipeOutput) {
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, MGItems.TITANIUM_INGOT)
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, MGItems.TITANIUM_NUGGET, 9)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, MGItems.TITANIUM_UPGRADE_SMITHING_TEMPLATE)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, MGItems.TITANIUM_UPGRADE_SMITHING_TEMPLATE, 2)
                .input('X', Items.NETHERITE_SCRAP)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, MGItems.ENDERITE_UPGRADE_SMITHING_TEMPLATE)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, MGItems.ENDERITE_UPGRADE_SMITHING_TEMPLATE, 2)
                .input('X', MGItems.TITANIUM_NUGGET)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, MGBlocks.ALLOY_SMELTER)
    ...
    protected static void alloySmeltingRecipe(RecipeExporter recipeOutput, Ingredient ingredients1, Ingredient ingredients2, ItemConvertible result, int outputCount){
        AlloySmeltingRecipeBuilder.alloySmeltingRecipe()
                ...
                .criterion(hasItem(ingredients1.getMatchingStacks()[0].getItem()), conditionsFromItem(ingredients1.getMatchingStacks()[0].getItem()))
                .offerTo(recipeOutput, Identifier.of(MoreGears.MODID, "alloy_smelting/" + getItemPath(result) + "_from_alloy_smelting"));
    }

    protected void arrowRecipe(RecipeExporter output, ItemConvertible ingot, ItemConvertible outputItem) {
        ShapedRecipeJsonBuilder.create(RecipeCategory.COMBAT, outputItem, 6)
                .input('#', Items.STICK)
                .input('X', ingot)
    ...
    protected void bowRecipe(RecipeExporter output, ItemConvertible ingot, ItemConvertible outputItem){
        ShapedRecipeJsonBuilder.create(RecipeCategory.COMBAT, outputItem)
                .input('#', ingot)
