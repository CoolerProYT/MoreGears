...
public class MGRecipeProvider extends FabricRecipeProvider {
    ...
    protected void arrowRecipe(Consumer<RecipeJsonProvider> output, ItemConvertible ingot, ItemConvertible outputItem) {
    ...
    protected void bowRecipe(Consumer<RecipeJsonProvider> output, ItemConvertible ingot, ItemConvertible outputItem){
