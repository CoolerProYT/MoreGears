...
public class MGModelProvider extends FabricModelProvider {
    public static final List<ItemModelGenerator.TrimMaterial> TRIM_MATERIAL_MODELS = List.of(
            ...
            new ItemModelGenerator.TrimMaterial("tin", MGTrimMaterials.TIN, Map.of()),
            new ItemModelGenerator.TrimMaterial("bronze", MGTrimMaterials.BRONZE, Map.of()),
            new ItemModelGenerator.TrimMaterial("steel", MGTrimMaterials.STEEL, Map.of()),
            new ItemModelGenerator.TrimMaterial("ruby", MGTrimMaterials.RUBY, Map.of()),
            new ItemModelGenerator.TrimMaterial("titanium", MGTrimMaterials.TITANIUM, Map.of()),
            new ItemModelGenerator.TrimMaterial("enderite", MGTrimMaterials.ENDERITE, Map.of())
    );
    ...
    public static final Identifier TRIM_PREFIX_HELMET = Identifier.of("trims/items/helmet_trim");
    public static final Identifier TRIM_PREFIX_CHESTPLATE = Identifier.of("trims/items/chestplate_trim");
    public static final Identifier TRIM_PREFIX_LEGGINGS = Identifier.of("trims/items/leggings_trim");
    public static final Identifier TRIM_PREFIX_BOOTS = Identifier.of("trims/items/boots_trim");
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        ...
        trimmedArmorItem(itemModelGenerator, Items.TURTLE_HELMET, EquipmentAssetKeys.TURTLE_SCUTE, TRIM_PREFIX_HELMET, MOD_TRIM_PREFIX_HELMET, false);
        trimmedArmorItem(itemModelGenerator, Items.LEATHER_HELMET, EquipmentAssetKeys.LEATHER, TRIM_PREFIX_HELMET, MOD_TRIM_PREFIX_HELMET, true);
        trimmedArmorItem(itemModelGenerator, Items.LEATHER_CHESTPLATE, EquipmentAssetKeys.LEATHER, TRIM_PREFIX_CHESTPLATE, MOD_TRIM_PREFIX_CHESTPLATE, true);
        trimmedArmorItem(itemModelGenerator, Items.LEATHER_LEGGINGS, EquipmentAssetKeys.LEATHER, TRIM_PREFIX_LEGGINGS, MOD_TRIM_PREFIX_LEGGINGS, true);
        trimmedArmorItem(itemModelGenerator, Items.LEATHER_BOOTS, EquipmentAssetKeys.LEATHER, TRIM_PREFIX_BOOTS, MOD_TRIM_PREFIX_BOOTS, true);
        trimmedArmorItem(itemModelGenerator, Items.CHAINMAIL_HELMET, EquipmentAssetKeys.CHAINMAIL, TRIM_PREFIX_HELMET, MOD_TRIM_PREFIX_HELMET, false);
        trimmedArmorItem(itemModelGenerator, Items.CHAINMAIL_CHESTPLATE, EquipmentAssetKeys.CHAINMAIL, TRIM_PREFIX_CHESTPLATE, MOD_TRIM_PREFIX_CHESTPLATE, false);
        trimmedArmorItem(itemModelGenerator, Items.CHAINMAIL_LEGGINGS, EquipmentAssetKeys.CHAINMAIL, TRIM_PREFIX_LEGGINGS, MOD_TRIM_PREFIX_LEGGINGS, false);
        trimmedArmorItem(itemModelGenerator, Items.CHAINMAIL_BOOTS, EquipmentAssetKeys.CHAINMAIL, TRIM_PREFIX_BOOTS, MOD_TRIM_PREFIX_BOOTS, false);
        trimmedArmorItem(itemModelGenerator, Items.IRON_HELMET, EquipmentAssetKeys.IRON, TRIM_PREFIX_HELMET, MOD_TRIM_PREFIX_HELMET, false);
        trimmedArmorItem(itemModelGenerator, Items.IRON_CHESTPLATE, EquipmentAssetKeys.IRON, TRIM_PREFIX_CHESTPLATE, MOD_TRIM_PREFIX_CHESTPLATE, false);
        trimmedArmorItem(itemModelGenerator, Items.IRON_LEGGINGS, EquipmentAssetKeys.IRON, TRIM_PREFIX_LEGGINGS, MOD_TRIM_PREFIX_LEGGINGS, false);
        trimmedArmorItem(itemModelGenerator, Items.IRON_BOOTS, EquipmentAssetKeys.IRON, TRIM_PREFIX_BOOTS, MOD_TRIM_PREFIX_BOOTS, false);
        trimmedArmorItem(itemModelGenerator, Items.DIAMOND_HELMET, EquipmentAssetKeys.DIAMOND, TRIM_PREFIX_HELMET, MOD_TRIM_PREFIX_HELMET, false);
        trimmedArmorItem(itemModelGenerator, Items.DIAMOND_CHESTPLATE, EquipmentAssetKeys.DIAMOND, TRIM_PREFIX_CHESTPLATE, MOD_TRIM_PREFIX_CHESTPLATE, false);
        trimmedArmorItem(itemModelGenerator, Items.DIAMOND_LEGGINGS, EquipmentAssetKeys.DIAMOND, TRIM_PREFIX_LEGGINGS, MOD_TRIM_PREFIX_LEGGINGS, false);
        trimmedArmorItem(itemModelGenerator, Items.DIAMOND_BOOTS, EquipmentAssetKeys.DIAMOND, TRIM_PREFIX_BOOTS, MOD_TRIM_PREFIX_BOOTS, false);
        trimmedArmorItem(itemModelGenerator, Items.GOLDEN_HELMET, EquipmentAssetKeys.GOLD, TRIM_PREFIX_HELMET, MOD_TRIM_PREFIX_HELMET, false);
        trimmedArmorItem(itemModelGenerator, Items.GOLDEN_CHESTPLATE, EquipmentAssetKeys.GOLD, TRIM_PREFIX_CHESTPLATE, MOD_TRIM_PREFIX_CHESTPLATE, false);
        trimmedArmorItem(itemModelGenerator, Items.GOLDEN_LEGGINGS, EquipmentAssetKeys.GOLD, TRIM_PREFIX_LEGGINGS, MOD_TRIM_PREFIX_LEGGINGS, false);
        trimmedArmorItem(itemModelGenerator, Items.GOLDEN_BOOTS, EquipmentAssetKeys.GOLD, TRIM_PREFIX_BOOTS, MOD_TRIM_PREFIX_BOOTS, false);
        trimmedArmorItem(itemModelGenerator, Items.NETHERITE_HELMET, EquipmentAssetKeys.NETHERITE, TRIM_PREFIX_HELMET, MOD_TRIM_PREFIX_HELMET, false);
        trimmedArmorItem(itemModelGenerator, Items.NETHERITE_CHESTPLATE, EquipmentAssetKeys.NETHERITE, TRIM_PREFIX_CHESTPLATE, MOD_TRIM_PREFIX_CHESTPLATE, false);
        trimmedArmorItem(itemModelGenerator, Items.NETHERITE_LEGGINGS, EquipmentAssetKeys.NETHERITE, TRIM_PREFIX_LEGGINGS, MOD_TRIM_PREFIX_LEGGINGS, false);
        trimmedArmorItem(itemModelGenerator, Items.NETHERITE_BOOTS, EquipmentAssetKeys.NETHERITE, TRIM_PREFIX_BOOTS, MOD_TRIM_PREFIX_BOOTS, false);
    ...
    public void generateTrimmableItem(ItemModelGenerator itemModels, Item armorItem, RegistryKey<EquipmentAsset> equipmentAsset, Identifier vanillaTrimLocation, Identifier modTrimLocation, boolean tint) {
        ...
        for (ItemModelGenerator.TrimMaterial trimMaterialData : TRIM_MATERIAL_MODELS) {
            Identifier Identifier3 = Identifier.withSuffixedPath("_" + trimMaterialData.name() + "_trim");
            Identifier Identifier4 = MGTrimMaterials.TRIM_MATERIALS.contains(trimMaterialData.name())
                    ? modTrimLocation.withSuffixedPath("_" + trimMaterialData.name())
                    : vanillaTrimLocation.withSuffixedPath("_" + trimMaterialData.name());
