...
public class MGToolMaterials {
    public static final ToolMaterial COPPER_TIER = new SimpleTier(MGTags.Blocks.INCORRECT_FOR_COPPER_TOOL, 200, 5f, 1.5f, 20, () -> Ingredient.fromTag(ConventionalItemTags.COPPER_INGOTS));
