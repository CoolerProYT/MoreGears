...
public class MGTrimMaterials {
    ...
    public static void bootstrap(Registerable<ArmorTrimMaterial> context) {
        register(context, TIN, MGItems.TIN_INGOT, Style.EMPTY.withColor(TextColor.parse("#9dc6e0").getOrThrow()), 0.5F);
        register(context, BRONZE, MGItems.BRONZE_INGOT, Style.EMPTY.withColor(TextColor.parse("#f1c232").getOrThrow()), 0.5F);
        register(context, STEEL, MGItems.STEEL_INGOT, Style.EMPTY.withColor(TextColor.parse("#6e6b6b").getOrThrow()), 0.5F);
        register(context, RUBY, MGItems.RUBY_INGOT, Style.EMPTY.withColor(TextColor.parse("#E0115F").getOrThrow()), 0.5F);
        register(context, TITANIUM, MGItems.TITANIUM_INGOT, Style.EMPTY.withColor(TextColor.parse("#9e6590").getOrThrow()), 0.5F);
        register(context, ENDERITE, MGItems.ENDERITE_INGOT, Style.EMPTY.withColor(TextColor.parse("#5D3391").getOrThrow()), 0.5F);
    }
