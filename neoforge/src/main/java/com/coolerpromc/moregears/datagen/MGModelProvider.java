...
public class MGModelProvider extends ModelProvider {
    ...
    public static final List<MGTrimMaterialData> TRIM_MATERIAL_MODELS = List.of(new MGTrimMaterialData(TrimMaterials.Palette.QUARTZ.suffix(), TrimMaterials.QUARTZ), new MGTrimMaterialData(TrimMaterials.Palette.IRON.suffix(), TrimMaterials.IRON, Map.of(EquipmentAssets.IRON, TrimMaterials.Palette.IRON_DARKER.suffix())), new MGTrimMaterialData(TrimMaterials.Palette.NETHERITE.suffix(), TrimMaterials.NETHERITE, Map.of(EquipmentAssets.NETHERITE, TrimMaterials.Palette.NETHERITE_DARKER.suffix())), new MGTrimMaterialData(TrimMaterials.Palette.REDSTONE.suffix(), TrimMaterials.REDSTONE), new MGTrimMaterialData(TrimMaterials.Palette.COPPER.suffix(), TrimMaterials.COPPER, Map.of(EquipmentAssets.COPPER, TrimMaterials.Palette.COPPER_DARKER.suffix())), new MGTrimMaterialData(TrimMaterials.Palette.GOLD.suffix(), TrimMaterials.GOLD, Map.of(EquipmentAssets.GOLD, TrimMaterials.Palette.GOLD_DARKER.suffix())), new MGTrimMaterialData(TrimMaterials.Palette.EMERALD.suffix(), TrimMaterials.EMERALD), new MGTrimMaterialData(TrimMaterials.Palette.DIAMOND.suffix(), TrimMaterials.DIAMOND, Map.of(EquipmentAssets.DIAMOND, TrimMaterials.Palette.DIAMOND_DARKER.suffix())), new MGTrimMaterialData(TrimMaterials.Palette.LAPIS.suffix(), TrimMaterials.LAPIS), new MGTrimMaterialData(TrimMaterials.Palette.AMETHYST.suffix(), TrimMaterials.AMETHYST), new MGTrimMaterialData(TrimMaterials.Palette.RESIN.suffix(), TrimMaterials.RESIN), new MGTrimMaterialData("tin", MGTrimMaterials.TIN), new MGTrimMaterialData("bronze", MGTrimMaterials.BRONZE), new MGTrimMaterialData("steel", MGTrimMaterials.STEEL), new MGTrimMaterialData("ruby", MGTrimMaterials.RUBY), new MGTrimMaterialData("echoite", MGTrimMaterials.ECHOITE), new MGTrimMaterialData("titanium", MGTrimMaterials.TITANIUM), new MGTrimMaterialData("enderite", MGTrimMaterials.ENDERITE));

    private record MGTrimMaterialData(String suffix, ResourceKey<TrimMaterial> materialKey,
