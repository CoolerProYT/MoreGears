...
public class MGRecipeProvider extends RecipeProvider {
    ...
    protected void oreCooking(List<ItemLike> ingredients, RecipeCategory category, ItemLike result, float experience, int cookingTime, String group) {
        oreCooking(SmeltingRecipe::new, ingredients, category, CookingBookCategory.MISC, result, experience, cookingTime, group, "_from_smelting");
        oreCooking(BlastingRecipe::new, ingredients, category, CookingBookCategory.MISC, result, experience, cookingTime, group, "_from_blasting");
    }
