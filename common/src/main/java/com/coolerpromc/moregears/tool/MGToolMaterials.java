...
public class MGToolMaterials {
    ...
    public static final ToolMaterial ECHOITE_TIER = new ToolMaterial(MGTags.Blocks.INCORRECT_FOR_ECHOITE_TOOL, 2000, 9.75f, 4.4f, 15, MGTags.Items.INGOTS_ECHOITE);
